...
import { state, } from "@/hooks/usePageLoading.ts"
...
export function useRenderLayout() {
        ...
        >
          ...
          >
            ...
            >
              ...
              {tagsView.value
                ? (
                    <TagView class="layout-border__bottom layout-border__top"></TagView>
                  )
                : undefined}
            </div>
  ...
  const renderTopLeft = () => {
    return (
      <>
        <div class="layout-border__bottom relative flex items-center bg-[var(--top-header-bg-color)] dark:bg-[var(--el-bg-color)]">
          {logo.value ? <Logo class="custom-hover"></Logo> : undefined}

          <ToolHeader class="flex-1"></ToolHeader>
        </div>
        <div class="absolute left-0 top-[var(--logo-height)+1px] h-[calc(100%-1px-var(--logo-height))] w-full flex">
          <Menu class="layout-border__right relative !h-full"></Menu>
          <div
            class={[
              `${prefixCls}-content`,
              "h-[100%]",
